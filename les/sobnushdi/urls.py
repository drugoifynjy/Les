...
from .views import StatementsView, StatementAdd, StatementMod, ContractsView, PersonWizardAdd
...
urlpatterns = [
    ...
    path('statement_wizard_add', PersonWizardAdd.as_view(), name='statement_wizard_add'),
